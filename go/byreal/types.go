...
type AmmAdminGroup struct {
	...
	RewardConfigManager solanago.PublicKey `json:"rewardConfigManager"`

	// the address who can manage the offchain reward claim
	RewardClaimManager solanago.PublicKey `json:"rewardClaimManager"`

	// the address who can manage the pool create action,
	// without this account's permission, no one can create a pool
	PoolManager solanago.PublicKey `json:"poolManager"`

	// the address who can manage the emergency action,
	// emergency action includes stop/resume the pool, stop/resume withdraw lp
	EmergencyManager solanago.PublicKey `json:"emergencyManager"`

	// normal action manager,
	// such as create amm config, update amm config
	NormalManager solanago.PublicKey `json:"normalManager"`

	// The space required for the account. may be used for future extensions.
	Pad [6]solanago.PublicKey `json:"pad"`
}

func (obj AmmAdminGroup) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	// Serialize `FeeKeeper`:
	err = encoder.Encode(obj.FeeKeeper)
	if err != nil {
		return errors.NewField("FeeKeeper", err)
	}
	// Serialize `RewardConfigManager`:
	err = encoder.Encode(obj.RewardConfigManager)
	if err != nil {
		return errors.NewField("RewardConfigManager", err)
	}
	// Serialize `RewardClaimManager`:
	err = encoder.Encode(obj.RewardClaimManager)
	if err != nil {
		return errors.NewField("RewardClaimManager", err)
	}
	// Serialize `PoolManager`:
	err = encoder.Encode(obj.PoolManager)
	if err != nil {
		return errors.NewField("PoolManager", err)
	}
	// Serialize `EmergencyManager`:
	err = encoder.Encode(obj.EmergencyManager)
	if err != nil {
		return errors.NewField("EmergencyManager", err)
	}
	// Serialize `NormalManager`:
	err = encoder.Encode(obj.NormalManager)
	if err != nil {
		return errors.NewField("NormalManager", err)
	}
	// Serialize `Pad`:
...
func (obj AmmAdminGroup) Marshal() ([]byte, error) {
	buf := bytes.NewBuffer(nil)
	encoder := binary.NewBorshEncoder(buf)
	err := obj.MarshalWithEncoder(encoder)
	if err != nil {
		return nil, fmt.Errorf("error while encoding AmmAdminGroup: %w", err)
	}
	return buf.Bytes(), nil
}

func (obj *AmmAdminGroup) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	// Deserialize `FeeKeeper`:
	err = decoder.Decode(&obj.FeeKeeper)
	if err != nil {
		return errors.NewField("FeeKeeper", err)
	}
	// Deserialize `RewardConfigManager`:
	err = decoder.Decode(&obj.RewardConfigManager)
	if err != nil {
		return errors.NewField("RewardConfigManager", err)
	}
	// Deserialize `RewardClaimManager`:
	err = decoder.Decode(&obj.RewardClaimManager)
	if err != nil {
		return errors.NewField("RewardClaimManager", err)
	}
	// Deserialize `PoolManager`:
	err = decoder.Decode(&obj.PoolManager)
	if err != nil {
		return errors.NewField("PoolManager", err)
	}
	// Deserialize `EmergencyManager`:
	err = decoder.Decode(&obj.EmergencyManager)
	if err != nil {
		return errors.NewField("EmergencyManager", err)
	}
	// Deserialize `NormalManager`:
	err = decoder.Decode(&obj.NormalManager)
	if err != nil {
		return errors.NewField("NormalManager", err)
	}
	// Deserialize `Pad`:
...
func (obj *AmmAdminGroup) Unmarshal(buf []byte) error {
	err := obj.UnmarshalWithDecoder(binary.NewBorshDecoder(buf))
	if err != nil {
		return fmt.Errorf("error while unmarshaling AmmAdminGroup: %w", err)
	}
	return nil
}

func UnmarshalAmmAdminGroup(buf []byte) (*AmmAdminGroup, error) {
	obj := new(AmmAdminGroup)
...
type InitAdminGroupParams struct {
	// the address who can hold the fee,
	// anyone can trigger the fee collection action,
	FeeKeeper solanago.PublicKey `json:"feeKeeper"`
...
func (obj InitAdminGroupParams) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	// Serialize `FeeKeeper`:
	err = encoder.Encode(obj.FeeKeeper)
	if err != nil {
		return errors.NewField("FeeKeeper", err)
...
func (obj InitAdminGroupParams) Marshal() ([]byte, error) {
	buf := bytes.NewBuffer(nil)
	encoder := binary.NewBorshEncoder(buf)
	err := obj.MarshalWithEncoder(encoder)
	if err != nil {
		return nil, fmt.Errorf("error while encoding InitAdminGroupParams: %w", err)
	}
	return buf.Bytes(), nil
}

func (obj *InitAdminGroupParams) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	// Deserialize `FeeKeeper`:
	err = decoder.Decode(&obj.FeeKeeper)
	if err != nil {
		return errors.NewField("FeeKeeper", err)
...
func (obj *InitAdminGroupParams) Unmarshal(buf []byte) error {
	err := obj.UnmarshalWithDecoder(binary.NewBorshDecoder(buf))
	if err != nil {
		return fmt.Errorf("error while unmarshaling InitAdminGroupParams: %w", err)
	}
	return nil
}

func UnmarshalInitAdminGroupParams(buf []byte) (*InitAdminGroupParams, error) {
	obj := new(InitAdminGroupParams)
	err := obj.Unmarshal(buf)
	if err != nil {
		return nil, err
	}
...
type ModifyAmmAdminGroupEvent struct {
	FeeKeeper           solanago.PublicKey `json:"feeKeeper"`
	RewardConfigManager solanago.PublicKey `json:"rewardConfigManager"`
	RewardClaimManager  solanago.PublicKey `json:"rewardClaimManager"`
	PoolManager         solanago.PublicKey `json:"poolManager"`
...
func (obj ModifyAmmAdminGroupEvent) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	// Serialize `FeeKeeper`:
	err = encoder.Encode(obj.FeeKeeper)
	if err != nil {
		return errors.NewField("FeeKeeper", err)
...
func (obj ModifyAmmAdminGroupEvent) Marshal() ([]byte, error) {
	buf := bytes.NewBuffer(nil)
	encoder := binary.NewBorshEncoder(buf)
	err := obj.MarshalWithEncoder(encoder)
	if err != nil {
		return nil, fmt.Errorf("error while encoding ModifyAmmAdminGroupEvent: %w", err)
	}
	return buf.Bytes(), nil
}

func (obj *ModifyAmmAdminGroupEvent) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	// Deserialize `FeeKeeper`:
	err = decoder.Decode(&obj.FeeKeeper)
	if err != nil {
		return errors.NewField("FeeKeeper", err)
...
func (obj *ModifyAmmAdminGroupEvent) Unmarshal(buf []byte) error {
	err := obj.UnmarshalWithDecoder(binary.NewBorshDecoder(buf))
	if err != nil {
		return fmt.Errorf("error while unmarshaling ModifyAmmAdminGroupEvent: %w", err)
	}
	return nil
}

func UnmarshalModifyAmmAdminGroupEvent(buf []byte) (*ModifyAmmAdminGroupEvent, error) {
	obj := new(ModifyAmmAdminGroupEvent)
	err := obj.Unmarshal(buf)
	if err != nil {
		return nil, err
	}
...
// Holds the current owner of the factory
type OffchainRewardConfig struct {
	// the pool state address
	PoolId solanago.PublicKey `json:"poolId"`

	// the vault to hold the reward
	// vault address is this config address
	RewardVault solanago.PublicKey `json:"rewardVault"`

	// Bump to identify vault PDA
	VaultBump [1]uint8 `json:"vaultBump"`

	// reward token mint address list
	// reward token account is ATA(reward_vault, reward_mint)
	RewardMintVec []solanago.PublicKey `json:"rewardMintVec"`
}

func (obj OffchainRewardConfig) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	// Serialize `PoolId`:
	err = encoder.Encode(obj.PoolId)
	if err != nil {
		return errors.NewField("PoolId", err)
	}
	// Serialize `RewardVault`:
	err = encoder.Encode(obj.RewardVault)
	if err != nil {
		return errors.NewField("RewardVault", err)
	}
	// Serialize `VaultBump`:
	...
	// Serialize `RewardMintVec`:
	err = encoder.Encode(obj.RewardMintVec)
	if err != nil {
		return errors.NewField("RewardMintVec", err)
	}
	return nil
}

func (obj OffchainRewardConfig) Marshal() ([]byte, error) {
	buf := bytes.NewBuffer(nil)
	encoder := binary.NewBorshEncoder(buf)
	err := obj.MarshalWithEncoder(encoder)
	if err != nil {
		return nil, fmt.Errorf("error while encoding OffchainRewardConfig: %w", err)
	}
	return buf.Bytes(), nil
}

func (obj *OffchainRewardConfig) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	// Deserialize `PoolId`:
	err = decoder.Decode(&obj.PoolId)
	if err != nil {
		return errors.NewField("PoolId", err)
	}
	// Deserialize `RewardVault`:
	err = decoder.Decode(&obj.RewardVault)
	if err != nil {
		return errors.NewField("RewardVault", err)
	}
	...
	// Deserialize `RewardMintVec`:
	err = decoder.Decode(&obj.RewardMintVec)
	if err != nil {
		return errors.NewField("RewardMintVec", err)
	}
	return nil
...
func (obj *OffchainRewardConfig) Unmarshal(buf []byte) error {
	err := obj.UnmarshalWithDecoder(binary.NewBorshDecoder(buf))
	if err != nil {
		return fmt.Errorf("error while unmarshaling OffchainRewardConfig: %w", err)
	}
	return nil
}

func UnmarshalOffchainRewardConfig(buf []byte) (*OffchainRewardConfig, error) {
	obj := new(OffchainRewardConfig)
	err := obj.Unmarshal(buf)
	if err != nil {
		return nil, err
	}
...
type UpdateAdminGroupParams struct {
	// the address who can hold the fee,
	// anyone can trigger the fee collection action,
	FeeKeeper *solanago.PublicKey `bin:"optional" json:"feeKeeper,omitempty"`

	// the address who can config the reward(config, deposit, withdraw),
	// deposit reward, set the account who can deposit the reward, withdraw the remaining reward(withdraw)
	RewardConfigManager *solanago.PublicKey `bin:"optional" json:"rewardConfigManager,omitempty"`

	// the address who can manage the offchain reward claim
	RewardClaimManager *solanago.PublicKey `bin:"optional" json:"rewardClaimManager,omitempty"`

	// the address who can manage the pool create action,
	// without this account's permission, no one can create a pool
	PoolManager *solanago.PublicKey `bin:"optional" json:"poolManager,omitempty"`

	// the address who can manage the emergency action,
	// emergency action includes stop/resume the pool, stop/resume withdraw lp
	EmergencyManager *solanago.PublicKey `bin:"optional" json:"emergencyManager,omitempty"`

	// normal action manager,
	// such as create amm config, update amm config
	NormalManager *solanago.PublicKey `bin:"optional" json:"normalManager,omitempty"`
}

func (obj UpdateAdminGroupParams) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	// Serialize `FeeKeeper` (optional):
	{
		if obj.FeeKeeper == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return errors.NewOption("FeeKeeper", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
	...
	// Serialize `RewardConfigManager` (optional):
	{
		if obj.RewardConfigManager == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return errors.NewOption("RewardConfigManager", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
	...
	// Serialize `RewardClaimManager` (optional):
	{
		if obj.RewardClaimManager == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return errors.NewOption("RewardClaimManager", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
	...
	// Serialize `PoolManager` (optional):
	{
		if obj.PoolManager == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return errors.NewOption("PoolManager", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
	...
	// Serialize `EmergencyManager` (optional):
	{
		if obj.EmergencyManager == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return errors.NewOption("EmergencyManager", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
	...
	// Serialize `NormalManager` (optional):
	{
		if obj.NormalManager == nil {
			err = encoder.WriteOption(false)
			if err != nil {
				return errors.NewOption("NormalManager", fmt.Errorf("error while encoding optionality: %w", err))
			}
		} else {
			err = encoder.WriteOption(true)
			if err != nil {
...
func (obj UpdateAdminGroupParams) Marshal() ([]byte, error) {
	buf := bytes.NewBuffer(nil)
	encoder := binary.NewBorshEncoder(buf)
	err := obj.MarshalWithEncoder(encoder)
	if err != nil {
		return nil, fmt.Errorf("error while encoding UpdateAdminGroupParams: %w", err)
	}
	return buf.Bytes(), nil
}

func (obj *UpdateAdminGroupParams) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	// Deserialize `FeeKeeper` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return errors.NewOption("FeeKeeper", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
			err = decoder.Decode(&obj.FeeKeeper)
			if err != nil {
	...
	// Deserialize `RewardConfigManager` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return errors.NewOption("RewardConfigManager", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
			err = decoder.Decode(&obj.RewardConfigManager)
			if err != nil {
	...
	// Deserialize `RewardClaimManager` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return errors.NewOption("RewardClaimManager", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
			err = decoder.Decode(&obj.RewardClaimManager)
			if err != nil {
	...
	// Deserialize `PoolManager` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return errors.NewOption("PoolManager", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
			err = decoder.Decode(&obj.PoolManager)
			if err != nil {
	...
	// Deserialize `EmergencyManager` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return errors.NewOption("EmergencyManager", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
			err = decoder.Decode(&obj.EmergencyManager)
			if err != nil {
	...
	// Deserialize `NormalManager` (optional):
	{
		ok, err := decoder.ReadOption()
		if err != nil {
			return errors.NewOption("NormalManager", fmt.Errorf("error while reading optionality: %w", err))
		}
		if ok {
			err = decoder.Decode(&obj.NormalManager)
			if err != nil {
...
func (obj *UpdateAdminGroupParams) Unmarshal(buf []byte) error {
	err := obj.UnmarshalWithDecoder(binary.NewBorshDecoder(buf))
	if err != nil {
		return fmt.Errorf("error while unmarshaling UpdateAdminGroupParams: %w", err)
	}
	return nil
}

func UnmarshalUpdateAdminGroupParams(buf []byte) (*UpdateAdminGroupParams, error) {
	obj := new(UpdateAdminGroupParams)
	err := obj.Unmarshal(buf)
	if err != nil {
		return nil, err
	}
