...
// Builds a "claim_offchain_reward" instruction.
// claim offchain reward from the pool
func NewClaimOffchainRewardInstruction(
	// Params:
	amountParam uint64,

	// Accounts:
	claimerAccount solanago.PublicKey,
	authorityAccount solanago.PublicKey,
	adminGroupAccount solanago.PublicKey,
	poolIdAccount solanago.PublicKey,
	tokenMintAccount solanago.PublicKey,
	claimerTokenAccountAccount solanago.PublicKey,
	rewardVaultTokenAccountAccount solanago.PublicKey,
	rewardConfigAccount solanago.PublicKey,
	...
	err := enc__.WriteBytes(Instruction_ClaimOffchainReward[:], false)
	if err != nil {
	...
	{
		// Account 0 "claimer": Writable, Signer, Required
		// the address who claim the offchain reward.
		accounts__.Append(solanago.NewAccountMeta(claimerAccount, true, true))
		...
		// Account 2 "admin_group": Read-only, Non-signer, Required
		// Initialize amm admin group account to store admin permissions.
		accounts__.Append(solanago.NewAccountMeta(adminGroupAccount, false, false))
		// Account 3 "pool_id": Read-only, Non-signer, Required
		// the pool id, which is the pool state account.
		accounts__.Append(solanago.NewAccountMeta(poolIdAccount, false, false))
		// Account 4 "token_mint": Read-only, Non-signer, Required
		accounts__.Append(solanago.NewAccountMeta(tokenMintAccount, false, false))
		// Account 5 "claimer_token_account": Writable, Non-signer, Required
		accounts__.Append(solanago.NewAccountMeta(claimerTokenAccountAccount, true, false))
		// Account 6 "reward_vault_token_account": Writable, Non-signer, Required
		accounts__.Append(solanago.NewAccountMeta(rewardVaultTokenAccountAccount, true, false))
		// Account 7 "reward_config": Read-only, Non-signer, Required
		// The offchain reward config account, it also is the reward vault account.
		accounts__.Append(solanago.NewAccountMeta(rewardConfigAccount, false, false))
...
func NewCollectFundFeeInstruction(
	...
	// Add the accounts to the instruction.
	{
		// Account 0 "admin_group": Read-only, Non-signer, Required
...
func NewCollectRemainingRewardsInstruction(
	...
	// Add the accounts to the instruction.
	{
		...
		// Account 1 "admin_group": Read-only, Non-signer, Required
		// amm admin group account to store admin permissions.
		accounts__.Append(solanago.NewAccountMeta(adminGroupAccount, false, false))
		// Account 2 "funder_token_account": Writable, Non-signer, Required
		...
		accounts__.Append(solanago.NewAccountMeta(poolStateAccount, true, false))
		// Account 4 "reward_token_vault": Read-only, Non-signer, Required
		...
		// Account 5 "reward_vault_mint": Read-only, Non-signer, Required
		...
		accounts__.Append(solanago.NewAccountMeta(tokenProgramAccount, false, false))
		// Account 7 "token_program_2022": Read-only, Non-signer, Required, Address: TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb
		// Token program 2022
		accounts__.Append(solanago.NewAccountMeta(tokenProgram2022account, false, false))
...
func NewCreateAmmConfigInstruction(
	...
	// Add the accounts to the instruction.
	{
		...
		// amm admin group account to store admin permissions.
		accounts__.Append(solanago.NewAccountMeta(adminGroupAccount, false, false))
		// Account 2 "amm_config": Writable, Non-signer, Required
...
func NewCreateOperationAccountInstruction(
	...
	// Add the accounts to the instruction.
	{
		...
		// amm admin group account to store admin permissions.
		accounts__.Append(solanago.NewAccountMeta(adminGroupAccount, false, false))
		// Account 2 "operation_state": Writable, Non-signer, Required
...
func NewCreatePoolInstruction(
	...
	poolManagerAccount solanago.PublicKey,
	adminGroupAccount solanago.PublicKey,
	ammConfigAccount solanago.PublicKey,
	poolStateAccount solanago.PublicKey,
	offchainRewardConfigAccount solanago.PublicKey,
	...
	// Add the accounts to the instruction.
	{
		...
		// Account 1 "pool_manager": Read-only, Signer, Required
		// with pool_manager permission, the pool creator can create a pool.
		accounts__.Append(solanago.NewAccountMeta(poolManagerAccount, false, true))
		// Account 2 "admin_group": Read-only, Non-signer, Required
		// amm admin group account to store admin permissions.
		accounts__.Append(solanago.NewAccountMeta(adminGroupAccount, false, false))
		...
		accounts__.Append(solanago.NewAccountMeta(poolStateAccount, true, false))
		// Account 5 "offchain_reward_config": Writable, Non-signer, Required
		// Initialize an account to store the off-chain reward config
		accounts__.Append(solanago.NewAccountMeta(offchainRewardConfigAccount, true, false))
		// Account 6 "token_mint_0": Read-only, Non-signer, Required
		...
		// Account 7 "token_mint_1": Read-only, Non-signer, Required
		// Token_1 mint
		accounts__.Append(solanago.NewAccountMeta(tokenMint1account, false, false))
		// Account 8 "token_vault_0": Writable, Non-signer, Required
		// Token_0 vault for the pool
		accounts__.Append(solanago.NewAccountMeta(tokenVault0account, true, false))
		// Account 9 "token_vault_1": Writable, Non-signer, Required
		// Token_1 vault for the pool
		accounts__.Append(solanago.NewAccountMeta(tokenVault1account, true, false))
		// Account 10 "observation_state": Writable, Non-signer, Required
		...
		// Account 11 "tick_array_bitmap": Writable, Non-signer, Required
		...
		// Account 12 "token_program_0": Read-only, Non-signer, Required
		// Spl token program or token program 2022
		accounts__.Append(solanago.NewAccountMeta(tokenProgram0account, false, false))
		// Account 13 "token_program_1": Read-only, Non-signer, Required
		// Spl token program or token program 2022
...
func NewCreateSupportMintAssociatedInstruction(
	...
	// Add the accounts to the instruction.
	{
		...
		// Support token mint
		accounts__.Append(solanago.NewAccountMeta(tokenMintAccount, false, false))
		// Account 3 "support_mint_associated": Writable, Non-signer, Required
...
// Builds a "deposit_offchain_reward" instruction.
// deposit offchain reward into the pool
func NewDepositOffchainRewardInstruction(
	// Params:
	amountParam uint64,
	...
	poolIdAccount solanago.PublicKey,
	tokenMintAccount solanago.PublicKey,
	payerTokenAccountAccount solanago.PublicKey,
	rewardVaultTokenAccountAccount solanago.PublicKey,
	rewardConfigAccount solanago.PublicKey,
	tokenProgramAccount solanago.PublicKey,
	associatedTokenProgramAccount solanago.PublicKey,
	...
	// Encode the instruction discriminator.
	err := enc__.WriteBytes(Instruction_DepositOffchainReward[:], false)
	if err != nil {
		return nil, fmt.Errorf("failed to write instruction discriminator: %w", err)
	}
	{
	...
	// Add the accounts to the instruction.
	{
		...
		// Account 4 "token_mint": Read-only, Non-signer, Required
		accounts__.Append(solanago.NewAccountMeta(tokenMintAccount, false, false))
		// Account 5 "payer_token_account": Writable, Non-signer, Required
		accounts__.Append(solanago.NewAccountMeta(payerTokenAccountAccount, true, false))
		// Account 6 "reward_vault_token_account": Writable, Non-signer, Required
		accounts__.Append(solanago.NewAccountMeta(rewardVaultTokenAccountAccount, true, false))
		// Account 7 "reward_config": Writable, Non-signer, Required
		// The offchain reward config account, it also is the reward vault account.
		accounts__.Append(solanago.NewAccountMeta(rewardConfigAccount, true, false))
		// Account 8 "token_program": Read-only, Non-signer, Required
		// Spl token program or token program 2022
		accounts__.Append(solanago.NewAccountMeta(tokenProgramAccount, false, false))
		// Account 9 "associated_token_program": Read-only, Non-signer, Required, Address: ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL
...
// Builds a "init_amm_admin_group" instruction.
// Initialize the AMM admin group account, which is used to manage the AMM protocol.
func NewInitAmmAdminGroupInstruction(
	// Params:
	paramsParam InitAdminGroupParams,
	...
	// Encode the instruction discriminator.
	err := enc__.WriteBytes(Instruction_InitAmmAdminGroup[:], false)
	if err != nil {
		return nil, fmt.Errorf("failed to write instruction discriminator: %w", err)
	}
	{
	...
	// Add the accounts to the instruction.
	{
		// Account 0 "payer": Writable, Signer, Required, Address: AY196f8U5EvM999PVnvLmyvaUnzL4GLiFaGKUgnJXN6o
		// only super admin can create admin group
		accounts__.Append(solanago.NewAccountMeta(payerAccount, true, true))
		// Account 1 "admin_group": Writable, Non-signer, Required
		// Initialize amm admin group account to store admin permissions.
		accounts__.Append(solanago.NewAccountMeta(adminGroupAccount, true, false))
...
func NewInitializeRewardInstruction(
	...
	// Add the accounts to the instruction.
	{
		...
		// Set reward for this pool
		accounts__.Append(solanago.NewAccountMeta(poolStateAccount, true, false))
		// Account 5 "operation_state": Read-only, Non-signer, Required
		...
		// Account 6 "reward_token_mint": Read-only, Non-signer, Required
		// Reward mint
		accounts__.Append(solanago.NewAccountMeta(rewardTokenMintAccount, false, false))
		// Account 7 "reward_token_vault": Writable, Non-signer, Required
		// A pda, reward vault
		accounts__.Append(solanago.NewAccountMeta(rewardTokenVaultAccount, true, false))
		// Account 8 "reward_token_program": Read-only, Non-signer, Required
...
// Builds a "update_amm_admin_group" instruction.
// Update the AMM admin group account, which is used to manage the AMM protocol.
func NewUpdateAmmAdminGroupInstruction(
	// Params:
	paramsParam UpdateAdminGroupParams,
	...
	// Encode the instruction discriminator.
	err := enc__.WriteBytes(Instruction_UpdateAmmAdminGroup[:], false)
	if err != nil {
		return nil, fmt.Errorf("failed to write instruction discriminator: %w", err)
	}
	{
...
// Builds a "withdraw_offchain_reward" instruction.
// withdraw offchain reward from the pool
func NewWithdrawOffchainRewardInstruction(
	// Params:
	amountParam uint64,
	...
	// Encode the instruction discriminator.
	err := enc__.WriteBytes(Instruction_WithdrawOffchainReward[:], false)
	if err != nil {
		return nil, fmt.Errorf("failed to write instruction discriminator: %w", err)
	}
	{
	...
	// Add the accounts to the instruction.
	{
		...
		// Initialize amm admin group account to store admin permissions.
		accounts__.Append(solanago.NewAccountMeta(adminGroupAccount, false, false))
		// Account 2 "pool_id": Read-only, Non-signer, Required
		// the pool id, which is the pool state account.
		accounts__.Append(solanago.NewAccountMeta(poolIdAccount, false, false))
		...
		// Account 5 "reward_vault_token_account": Writable, Non-signer, Required
		accounts__.Append(solanago.NewAccountMeta(rewardVaultTokenAccountAccount, true, false))
		// Account 6 "reward_config": Writable, Non-signer, Required
		// The offchain reward config account, it also is the reward vault account.
		accounts__.Append(solanago.NewAccountMeta(rewardConfigAccount, true, false))
